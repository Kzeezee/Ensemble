...
const routes: Routes = [
  ...
  {path:'content/dashboard', component: DashboardComponent}
];
...
export const RoutingComponents = [HomeComponent, LoginComponent, RegisterComponent, OurstoryComponent, PricingComponent, DashboardComponent]
